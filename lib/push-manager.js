...
function PushManager(settings) {
    ...
    this.Installation = settings.Installation || require('../models/installation');
...
setRemoting(PushManager.prototype.notifyById, {
  description: 'Send a push notification by installation id',
  accepts: [
    {arg: 'installationId', type: 'string', description: 'Installation id', http: {source: 'query'}},
...
setRemoting(PushManager.prototype.notifyByQuery, {
  ...
  accepts: [
    {arg: 'deviceQuery', type: 'object', description: 'Installation query', http: {source: 'body'}},
    {arg: 'notification', type: 'object', description: 'Notification', http: {source: 'body'}}
  ],
  returns: {arg: 'data', type: 'object', root: true},
