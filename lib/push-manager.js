...
function PushManager(settings) {
    ...
    this.Installation = loopback.getModel(settings.installation) || require('../models/installation');
    this.Notification = loopback.getModel(settings.notification) || require('../models/notification');
    this.Application = loopback.getModel(settings.application) || require('loopback').Application;
