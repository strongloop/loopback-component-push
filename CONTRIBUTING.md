...
Thank you for your interest in `loopback-component-push`, an open source project
administered by StrongLoop.

Contributing to `loopback-component-push` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/loopback-component-push)
